...
def key_deter(cx,cy): 
    '''
    determines which key is pressed based on the center of the contour(yellow paper) 
    '''
    if cy>50 and cy<100: 
        if cx>50 and cx<100: 
            print("1") 
...
def keyboard_layout(): 
    ...
    for i in list_1: 
        ...
        27 
        x=x+50 
    list_2='a s d f g h j k l enter' 
    list_2=list_2.split(" ") 
    x=50 
    for i in list_2: 
        y=200 
        ...
        x=x+50 
    #cv2.putText(frame,"enter",(x+7,90+90),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0),2) 
    list_3='z x c v b n m capslock' 
    list_3=list_3.split(" ") 
    x=50 
    for i in list_3: 
        y=250 
    ...
    x=100 
    y=300 
    cv2.rectangle(frame,(50,50),(100,250),(0,255,0),2) 
    cv2.putText(frame,"shift",(50+7,90+190),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0),2) 
...
def main():
    ...
    while(1): 
        ...
        lower_yellow = np.array([20, 100, 100])#change this hsv values if yellow color as per your lighting condition 
        upper_yellow = np.array([30,255,255])#same as above 
